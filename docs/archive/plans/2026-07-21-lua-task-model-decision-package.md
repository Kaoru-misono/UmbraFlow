...
> 状态:已完成并归档(2026-07-24)——完整版本已归档，裁决与产品方向已吸收进 grill-decisions 和 roadmap 权威文档。
>
> 本文档已从"grill 前弹药"**瘦身为调研档案**。grill 已完成,Q1–Q10 的**最终裁决**见
> [`2026-07-21-lua-task-model-grill-decisions.md`](../../plans/2026-07-21-lua-task-model-grill-decisions.md)(D0–D10),产品方向与 roadmap 见
> [`2026-07-21-product-form-and-roadmap.md`](../../plans/2026-07-21-product-form-and-roadmap.md)。**那两份是当前权威**。
>
> **本档保留什么**:§1(硬约束底座 / 加载时性质净损失分析,与脚本语言无关)、§2(四路联网调研一手结论 + 来源链接)、
> §3(Q1–Q10 完整正反论证)。这些是长期引用价值——**理论地基和论证过程**,裁决日志只记结论不记推导。
>
> **已删除什么**(内容已被取代,完整旧版留档 [`…FULL.md`](2026-07-21-lua-task-model-decision-package.FULL.md)):
...
> [`2026-07-21-lua-task-model-grill-decisions.md`](../../plans/2026-07-21-lua-task-model-grill-decisions.md) D6。
