...
| Proposes `allowed_ui_actions` naming actions the runtime model does not contain | Out of W2's reach. Binding resolution is the Host's, and `Host::deliver` is not joined to the ledger until W4. |
