...
namespace uf::m0_demo
{
    ...
    TEST_CASE("m0 annotation session refuses an unconfined output before observing")
    {
    ...
    TEST_CASE("m0 annotation session encodes the before-frame only after delivery")
    {
    ...
    TEST_CASE("m0 annotation session ends the run only when the window was replaced")
    {
    ...
    TEST_CASE("m0 annotation session reports the drive's own client size")
    {
