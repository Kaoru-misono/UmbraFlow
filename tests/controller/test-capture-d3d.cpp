...
namespace uf
{
    ...
    {
        constexpr auto width = uint32{2};
        constexpr auto height = uint32{2};
        ...
        auto const packed = controller_detail::readbackBgra8(
            source,
            rowPitch,
            width,
            height
    ...
    {
        auto const crop = controller_detail::ClientCropRect::create(
            {2'564, 1'487},
            {2'564, 1'487},
            {2, 45},
            {2'560, 1'440}
